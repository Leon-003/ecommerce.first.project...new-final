    ...
    <body>
        ...
        <section id="prodetails" class="section-p1">
            <div class="single-pro-image">
                <img src="img/products/noodles.jfif" width="100%" id="MainImg" alt="">
                <div class="small-img-group">
                    <div class="small-img-col">
                        <img src="img/products/noodles1.jfif" width="100%" class="small-img" alt="">  
                    </div>
                    <div class="small-img-col">
                        <img src="img/products/noodles2.jfif" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="img/products/noodles3.jfif" width="100%" class="small-img" alt="">  
                    </div>
                    <div class="small-img-col">
                        <img src="img/products/noodles4.jfif" width="100%" class="small-img" alt="">  
                    </div>
            ...
            <div class="single-pro-details">
                ...
                <span>
                    The classic MAGGI 2minutes Masala Noodles is fortified with Vitamin A, Iron and Iodine. The tastemaker is comprised of popular ingredients typically found in Bangladeshi households, such as turmeric, pepper, coriander, ginger and cardamom.
                </span>
            </div>
        </section>
